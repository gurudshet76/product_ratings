            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body"> <!-- modal body start -->
                            {{ Form::open(array('url'=>'/editproduct','class'=>'form-horizontal', 'method'=> 'POST')) }}
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('product_id',  null, array('class'=>'span3', 'placeholder'=>'Product Id')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('product_name', null, array('class'=>'span3', 'placeholder'=>'Product Name')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::textarea('product_desc', null, array('class'=>'span3', 'placeholder'=>'Description')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('cameratype', null, array('class'=>'span3', 'placeholder'=>'Camera type')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('weight_g', null, array('class'=>'span3', 'placeholder'=>'Weight')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('storagesize_m', null, array('class'=>'span3', 'placeholder'=>'Internal Memory')) }}-->
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                            <!--{{ Form::text('price_v', null, array('class'=>'span3', 'placeholder'=>'Price')) }}-->
        ...
        <div class="modal fade" id="prodAddModal" tabindex="-1" role="dialog" aria-labelledby="prodModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body"> <!-- modal body start -->
                            {{ Form::open(array('url'=>'/addproduct','class'=>'form-horizontal', 'method'=> 'POST')) }}
                            ...
                            <div class="control-group">
                                    <label for="productid" class="control-label">Product Id:</label>
                                    <div class="controls">
                                            {{ Form::text('productid', null, array('class'=>'span3', 'placeholder'=>'Product Id')) }}
                                    </div>
                            </div>
                            ...
                            <div class="control-group">
                                    <label for="productname" class="control-label">Product Name:</label>
                                    <div class="controls">
                                            {{ Form::text('productname', null, array('class'=>'span3', 'placeholder'=>'Product Name')) }}
                                    </div>
                            </div>
                            ...
                            <div class="control-group">
                                    <label for="productdesc" class="control-label">Product Description:</label>
                                    <div class="controls">
                                            {{ Form::textarea('productdesc', null, array('class'=>'span3', 'placeholder'=>'Description')) }}
                                    </div>
                            </div> <!-- /field -->
                            ...
                            <div class="control-group">
                                    <label for="camera_type" class="control-label">Camera (MP): </label>
                                    <div class="controls">
                                            {{ Form::text('camera_type', null, array('class'=>'span3', 'placeholder'=>'Camera type')) }}
                                    </div>
                            </div> <!-- /field -->
                            ...
                            <div class="control-group">
                                    <label for="weight" class="control-label">Weight (g): </label>
                                    <div class="controls">
                                            {{ Form::text('weight', null, array('class'=>'span3', 'placeholder'=>'Weight')) }}
                                    </div>
                            </div> <!-- /field -->
                            ...
                            <div class="control-group">
                                    <label for="storagesize" class="control-label">Internal Memroy(GB) </label>
                                    <div class="controls">
                                            {{ Form::text('storagesize', null, array('class'=>'span3', 'placeholder'=>'Internal Memory')) }}
                                    </div>
                            </div> <!-- /field -->
                            ...
                            <div class="control-group">
                                    <label for="price" class="control-label">Price: </label>
                                    <div class="controls">
                                            {{ Form::text('price', null, array('class'=>'span3', 'placeholder'=>'Price')) }}
                                    </div>
                            </div> <!-- /field -->
...
<!--        
        <div class="row">
    		<div class="panel panel-primary">
                ...
                <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('importExcelFile') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <form action="{{ URL::to('proddelete') }}" class="form-horizontal" method="post">
		     <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3>Products
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="success">
                            <!--<td class="col-check"><input  name="checkedprods[]" type="checkbox" id="{{$prod->cnt_id}}" value="{{$prod->cnt_id}}" ></td>-->
                            <td>{{$prod->prod_id}}</td>
                            <td>{{$prod->prod_name}}</td>
                            <td>{{$prod->prod_desc}}</td>
                            <td>{{$prod->camera_type}}</td>
                            <td>{{$prod->weight}}</td>
                            <td>{{$prod->storage_size}}</td>
                            <td>{{$prod->price}}</td>
                            <!--<td><button type="button" class="btn btn-primary btn-xs edit-page" data-toggle="modal" data-target="#prodEditModal" id="btProdEditModal" 
                                        ...
                                        data-desc="{{$prod->prod_desc}}" 
                                        data-camera="{{$prod->camera_type}}"
                                        data-weight="{{$prod->weight}}"
                                        data-size="{{$prod->storage_size}}"
