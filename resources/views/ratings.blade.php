					...
					<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-body"> <!-- modal body start -->
										{{ Form::open(array('url'=>'/addratings','class'=>'form-horizontal', 'method'=> 'POST')) }}
														...
														<div class="controls">
																<select name="productname" >
																	@foreach ($products as $prod)
																			<option value="{{$prod->prod_name}}">{{$prod->prod_name}}</option>
																	@endforeach
																</select>
												...
												<div class="control-group">
														...
														<div class="controls">
																{{ Form::text('customer_name', null, array('class'=>'span3', 'placeholder'=>'Name')) }}
														</div>
												</div> <!-- /field -->
												...
												<div class="control-group">
														...
														<div class="controls">
																{{ Form::textarea('comments', null, array('class'=>'span3', 'placeholder'=>'Comments')) }}
														</div>
												</div> <!-- /field -->
    		...
    		<div class="panel panel-primary">
                <div class="panel-heading">
                    <h4>Upload ratings
                            ...
                            <form action="{{ URL::to('addratings') }}" class="form-horizontal" method="post">
                ...
                <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('importJsonFile') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
